...
public class RestExpress
{
    ...
    /**
     * Change the default behavior for serialization. If no
     * SerializationProvider is set, default of DefaultSerializationProvider is
     * used, which uses Jackson for JSON, XStream for XML.
     * 
     * @param provider
     *            a SerializationProvider instance.
     */
    ...
    /**
     * Change the serialization provider for this server instance. If no
     * SerializationProcessor is set, default of DefaultSerializationProcessor
     * is used, which uses Jackson for JSON, XStream for XML.
     * 
     * @param provider
    ...
    /**
     * Get the serialization provider for this server instance. If none has been
     * set, it is set to the default serialization processor and returned.
    ...
    public ChannelHandler buildRequestHandler()
    {
        ...
        DefaultRequestHandler requestHandler = new DefaultRequestHandler(createRouteResolver(), serializationProvider(),
    ...
    public Channel bind(InetSocketAddress ipAddress)
    {
        ...
        bootstrap.childHandler(new PipelineInitializer().setExecutionHandler(initializeExecutorGroup()).addRequestHandler(buildRequestHandler())
                .setSSLContext(sslContext).setMaxContentLength(serverSettings.getMaxContentSize()));
