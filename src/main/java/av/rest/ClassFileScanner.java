...
import av.nado.util.StringUtil;

public class ClassFileScanner
{
    private Logger      logger = LogManager.getLogger(ClassFileScanner.class);
     ...
     */
    public ClassFileScanner(String basePackage)
    {
     ...
     */
    public ClassFileScanner(String basePackage, ClassLoader cl)
    {
        this.basePackage = basePackage;
        this.cl = cl;
    }
     ...
     * @throws IOException
     */
    public Set<String> getFullyQualifiedClassNameList() throws IOException
    {
     ...
     * @throws IOException
     */
    private Set<String> doScan(String basePackage, Set<String> nameList) throws IOException
    {
